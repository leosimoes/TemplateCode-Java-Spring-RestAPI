...
import com.project.restapi.exceptions.MainNameAlreadyRegisteredException;
import com.project.restapi.exceptions.MainNotFoundException;
...
public class MainServiceImpl implements MainService{
    ...
    public MainPayload create(MainPayload mainPayload) {
        ...
        if(this.mainRepository.existsByNameEqualsIgnoreCase(name)){
            throw new MainNameAlreadyRegisteredException("Exception in mainService.create() - Name Already Registered");
        }
    ...
    public MainPayload getByName(String name) {
        ...
        if(mainEntityOpt.isEmpty()){
            throw new MainNotFoundException("Exception in mainService.getByName() - MainEntity Not Found");
        }
    ...
    public MainPayload update(MainPayload mainPayload) {
        ...
        Optional<MainEntity> mainEntityOpt = this.mainRepository.findByNameEqualsIgnoreCase(name);
        if(mainEntityOpt.isEmpty()){
            throw new MainNotFoundException("Exception in mainService.update() - MainEntity Not Found");
        }
    ...
    public void deleteByName(String name) {
        Optional<MainEntity> mainEntityOpt = this.mainRepository.findByNameEqualsIgnoreCase(name);
        if(mainEntityOpt.isEmpty()){
            throw new MainNotFoundException("Exception in mainService.deleteByName() - MainEntity Not Found");
        }
